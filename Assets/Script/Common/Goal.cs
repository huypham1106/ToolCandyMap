...
namespace CandyMatch3.Game.Common
{
    ...
    public class CollectSpecialCandyGoal : Goal
    {
        ...
        public override bool IsComplete(GameState state)
        {
            return state.collectedSpecialCandies[type] >= amount;
        ...
        public override void Draw()
        {
            ...
            GUILayout.BeginHorizontal();
            EditorGUILayout.PrefixLabel("Type");
            type = (SpecialCandyType)EditorGUILayout.EnumPopup(type, GUILayout.Width(100));
            GUILayout.EndHorizontal();
    ...
    public class CollectMultiBlockGoal : Goal
    {
        ...
        public override bool IsComplete(GameState state)
        {
            return state.collectedMultiBlocks[type] >= amount;
        }
        ...
        public override void Draw()
        {
            ...
            GUILayout.BeginHorizontal();
            EditorGUILayout.PrefixLabel("Type");
            type = (MultiBlockType)EditorGUILayout.EnumPopup(type, GUILayout.Width(100));
            GUILayout.EndHorizontal();
