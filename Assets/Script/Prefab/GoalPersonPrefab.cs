...
public class GoalPersonPrefab : MonoBehaviour
{
    ...
    {
        Destroy(gameObject);
        MainGameController.Instance.goEditInformation.SetActive(false);
    ...
    {
        MainGameController.Instance.checkClickOtherGoalPerson(this);
        if (allowClick)
        {
            MainGameController.Instance.getDataGoalPerson(this);   

            if (MainGameController.Instance.goEditInformation.activeSelf)
            {
